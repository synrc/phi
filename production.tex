...
\fancyfoot[L]{\small\color{footergray} Toward BEAM Interoperability: PureScript vs Haskell vs Elixir Reimplementation}
...
\begin{titlepage}
  ...
  {\LARGE \textbf{Interoperability and Elixir Reimplementation} \par} \vspace{2.5cm}
...
\begin{itemize}
\item PureScript targets JavaScript runtimes (Node/browser), lacking native BEAM integration.
\item Haskell offers GHCJS or external FFI bridges, but loses BEAM's lightweight processes and OTP patterns.
\end{itemize}
