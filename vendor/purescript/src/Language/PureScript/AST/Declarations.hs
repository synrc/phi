...
data SimpleErrorMessage
  ...
  | FFIFunSameNameWithModule ModuleName [Ident]
...
isTrueExpr (Var _ (Qualified (Just (ModuleName [ProperName "Data", ProperName "Bool"])) (Ident "otherwise"))) = True
