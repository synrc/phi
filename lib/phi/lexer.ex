defmodule Phi.Lexer do
  ...
  defp lex([?(, ?) | rest], line, col, acc),
    do: lex(rest, line, col + 2, [{:unit, line, col} | acc])
  ...
  defp lex([?` | rest], line, col, acc),
    do: lex(rest, line, col + 1, [{:backtick, line, col} | acc])

  # Double colon, Arrow, Double Arrow
  defp lex([?:, ?: | rest], line, col, acc),
    do: lex(rest, line, col + 2, [{:double_colon, line, col} | acc])

  defp lex([?-, ?> | rest], line, col, acc),
    do: lex(rest, line, col + 2, [{:arrow, line, col} | acc])

  defp lex([?=, ?> | rest], line, col, acc),
    do: lex(rest, line, col + 2, [{:double_arrow, line, col} | acc])
  ...
  defp lex_block_comment([?\n | rest], line, _col, acc),
    do: lex_block_comment(rest, line + 1, 1, acc)

  defp lex_block_comment([_ | rest], line, col, acc),
    do: lex_block_comment(rest, line, col + 1, acc)
