...
%name parseDecl decl
%name parseTopBinding topBinding
...
%token
  ...
  'after'         { SourceToken _ (TokLowerName [] "after") }
...
topBinding :: { TopBinding () }
  : binder1 '=' exprWhere { TopBinding () $1 $2 $3 }
...
instHead :: { InstanceHead () }
  : 'instance' constraints '=>' qualProperName manyOrEmpty(typeAtom)
      { InstanceHead $1 (Just ($2, $3)) (getQualifiedProperName $4) $5 }
  | 'instance' qualProperName manyOrEmpty(typeAtom)
      { InstanceHead $1 Nothing (getQualifiedProperName $2) $3 }
